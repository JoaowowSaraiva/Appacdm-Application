...
To build the final jar and optimize the appacdmapplication application for production, run:
...
Then navigate to [http://localhost:81000](http://localhost:81000) in your browser.
