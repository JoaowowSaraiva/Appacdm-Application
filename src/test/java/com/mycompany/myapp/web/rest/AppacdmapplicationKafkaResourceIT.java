...
import com.mycompany.myapp.AppacdmapplicationApp;
...
@SpringBootTest(classes = AppacdmapplicationApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class AppacdmapplicationKafkaResourceIT {
    ...
    @Autowired
    private AppacdmapplicationKafkaProducer producer;

    @Autowired
    private AppacdmapplicationKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        AppacdmapplicationKafkaResource kafkaResource = new AppacdmapplicationKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/appacdmapplication-kafka/publish?message=test"))
